...
#ifndef __INET_Ipv4RoutingTableLR_H
#define __INET_Ipv4RoutingTableLR_H
 ...
 */
class INET_API Ipv4RoutingTableLR : public cSimpleModule, public IIpv4RoutingTable, protected cListener, public ILifecycle
{
  protected:
    ...
    typedef std::map<Ipv4Address, std::vector<Ipv4Route *>> RoutingCache;
  ...
  protected:
    ...
    class RouteLessThan
    {
        const Ipv4RoutingTableLR &c;
      public:
        RouteLessThan(const Ipv4RoutingTableLR& c) : c(c) {}
...
#endif // ifndef __INET_Ipv4RoutingTableLR_H
