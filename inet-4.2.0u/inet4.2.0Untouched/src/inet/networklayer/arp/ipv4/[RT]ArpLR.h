 ...
 * ARP implementation.
 */
class INET_API ArpLR : public OperationalBase, public IArp
{
  public:
    class ArpCacheEntryLR;
    typedef std::map<Ipv4Address, std::vector<ArpCacheEntryLR *>> ArpCache;
    ...
    {
      public:
        ArpLR *owner = nullptr;    // owner ARP module of this cache entry
  ...
  protected:
    ...
    virtual void initiateArpResolution(ArpCacheEntryLR *entry);
    ...
    virtual void updateArpCache(ArpCacheEntryLR *entry, const MacAddress& macAddress);
